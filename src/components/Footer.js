        ...
        >
          <CDBBox display="flex" justifyContent="between" className="flex-wrap">
            <CDBBox>
              <a href="/" className="d-flex align-items-center p-0 text-dark">
                <img alt="logo" src="/images/freshpick.png" width="100px" />
                <span className="ml-3 h5 font-weight-bold">Freshpick</span>
              </a>
            </CDBBox>
            <CDBBox
              display="flex"
            ...
            >
              <CDBBox>
                ...
                >
                  ...
                  <CDBFooterLink href="/">youremail here</CDBFooterLink>
                </CDBBox>
              </CDBBox>
              <CDBBox>
                <p className="h5 mb-4" style={{ fontWeight: "600" }}>
          ...
          <CDBBox display="flex" className="mt-4" justifyContent="between">
            <small className="ml-2">
              &copy; Freshpick, 2022. All rights reserved.
            </small>
            <CDBBox display="flex">
